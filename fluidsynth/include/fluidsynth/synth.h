...
FLUIDSYNTH_API int fluid_synth_noteon_with_seek(fluid_synth_t* synth, int chan, int key, int vel, int ticks);
...
FLUIDSYNTH_API int fluid_synth_event_reset(fluid_synth_t *synth);

FLUIDSYNTH_API int fluid_synth_set_mute(fluid_synth_t* synth, int chan, int mute);
FLUIDSYNTH_API int fluid_synth_set_solo(fluid_synth_t* synth, int chan, int solo);
...
FLUIDSYNTH_API int fluid_synth_set_preset_amp_offsets(fluid_synth_t* synth, const char *name, fluid_list_t* preset_amp_offset_list);
FLUIDSYNTH_API int fluid_synth_set_preset_amp_offset(fluid_synth_t* synth, const char *name, int bank_num, int preset_num, double offset);
FLUIDSYNTH_API fluid_list_t* fluid_synth_get_preset_amp_offsets(fluid_synth_t* synth, const char *name );
FLUIDSYNTH_API double fluid_synth_get_preset_amp_offset(fluid_synth_t* synth, const char *name, int bank_num, int preset_num );
FLUIDSYNTH_API void fluid_synth_delete_preset_amp_offsets(fluid_synth_t* synth, const char *name);
FLUIDSYNTH_API void fluid_synth_delete_preset_amp_offset(fluid_synth_t* synth, const char *name, int bank_num, int preset_num);
FLUIDSYNTH_API void fluid_synth_delete_preset_amp_offsets_all(fluid_synth_t* synth);

FLUIDSYNTH_API int fluid_synth_set_channel_gain(fluid_synth_t* synth, int channum, double chan_gain);
FLUIDSYNTH_API double fluid_synth_get_channel_gain(fluid_synth_t* synth, int channum);
...
FLUIDSYNTH_API void fluid_synth_start_voice_with_seek(fluid_synth_t* synth, fluid_voice_t* voice, int ticks);
FLUIDSYNTH_API void fluid_synth_get_voicelist(fluid_synth_t* synth,
                                              fluid_voice_t* buf[], int bufsize, int ID);
FLUIDSYNTH_API int fluid_synth_handle_midi_event(void* data, fluid_midi_event_t* event);
FLUIDSYNTH_API int fluid_synth_handle_midi_seek_event(void* data, fluid_midi_event_t* event, int ticks);
FLUIDSYNTH_API
FLUID_DEPRECATED 
void fluid_synth_set_midi_router(fluid_synth_t* synth, fluid_midi_router_t* router);

FLUIDSYNTH_API void delete_fluid_preset_amp_offset_list(void* data);
FLUIDSYNTH_API void delete_fluid_preset_amp_offset_list_all(void* data);
