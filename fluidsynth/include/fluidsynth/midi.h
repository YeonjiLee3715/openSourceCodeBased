...
FLUIDSYNTH_API int fluid_midi_event_get_duration(fluid_midi_event_t* evt);
FLUIDSYNTH_API int fluid_midi_event_set_duration(fluid_midi_event_t* evt, int duration);
...
typedef int (*handle_midi_seek_event_func_t)(void* data, fluid_midi_event_t* event, int ticks);
...
{
  FLUID_PLAYER_STOPPED,         /**< Player is stopped */
...
FLUIDSYNTH_API int fluid_player_set_tempo_offset_bpm(fluid_player_t* player, int bpm);
FLUIDSYNTH_API int fluid_player_set_tempo_offset_timeCoeff(fluid_player_t* player, float coeff);
FLUIDSYNTH_API int fluid_player_set_playback_callback(fluid_player_t* player, handle_midi_event_func_t handler, handle_midi_seek_event_func_t seek_handler, void *handler_data);

FLUIDSYNTH_API int fluid_player_get_status(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_duration_ticks(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_duration_msec(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_play_duration_msec(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_total_ticks(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_total_msec(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_convert_msec_to_ticks(fluid_player_t * player, unsigned int msec);
FLUIDSYNTH_API unsigned int fluid_player_convert_ticks_to_msec(fluid_player_t * player, int ticks);
...
FLUIDSYNTH_API int fluid_player_get_tempo_offset_bpm(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_play_tempo(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_get_player_bpm(fluid_player_t* player);
FLUIDSYNTH_API double fluid_player_get_player_deltatime(fluid_player_t* player);
FLUIDSYNTH_API double fluid_player_get_player_playdeltatime(fluid_player_t* player);
FLUIDSYNTH_API int fluid_player_seek_ticks(fluid_player_t* player, int ticks);
FLUIDSYNTH_API int fluid_player_seek_msec(fluid_player_t* player, int msec);

FLUIDSYNTH_API int fluid_player_get_channel_index_from_track_index(fluid_player_t* player, int ntrack);
///
