...
typedef struct _fluid_preset_amp_offset_t
{
	unsigned int bank_num;                /* the bank number */
	unsigned int preset_num;              /* the preset number */
	double amp_offset;                    /* the amplitude offset 0.0 ~ 1.5 def: 1.0 */
} fluid_preset_amp_offset_t;
...
struct _fluid_synth_t
{
  ...
  fluid_list_t* preset_amp_offset_list;		/**< Currently selected preset amplitude offset list */
  fluid_hashtable_t* preset_amp_offset_hash;

  float gain;                        /**< master gain */
  int* solo;
  int* mute;
  fluid_channel_t** channel;         /**< the channels */
  float* channel_gain;         		/**< the channel gain */
