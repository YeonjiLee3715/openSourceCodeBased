...
struct _fluid_voice_t
{
	...
	/* preset amplitude offset (dupe in rvoice) */
	fluid_real_t preset_amplitude_offset;
	fluid_real_t chan_gain;
...
int fluid_voice_init(fluid_voice_t* voice, fluid_sample_t* sample,
		     ...
		     unsigned int id, unsigned int time, fluid_real_t gain, fluid_real_t amp_offset);
...
void fluid_voice_update_mute_status(fluid_voice_t* voice);
