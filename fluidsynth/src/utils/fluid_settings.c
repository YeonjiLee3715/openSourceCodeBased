...
new_fluid_str_setting(const char* value, const char* def, int hints, fluid_str_update_t fun, void* data)
{
  ...
  FLUID_MEMSET(str, 0, sizeof(fluid_str_setting_t));
		     ...
		     int hints, fluid_num_update_t fun, void* data)
{
  ...
  FLUID_MEMSET(setting, 0, sizeof(fluid_num_setting_t));
...
{
  fluid_int_setting_t* setting = NULL;
  ...
  FLUID_MEMSET(setting, 0, sizeof(fluid_set_setting_t));
...
{
  fluid_set_setting_t* setting = NULL;
                              ...
                              const char *separator)
{
  ...
  FLUID_MEMSET( str, 0, sizeof(char)*len );
