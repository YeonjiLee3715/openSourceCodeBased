...
int fluid_defpreset_preset_noteon_with_seek(fluid_preset_t* preset, fluid_synth_t* synth, int chan, int key, int vel, int ticks);
...
int fluid_defsfont_load_sampledata(fluid_defsfont_t* sfont, const fluid_file_callbacks_t* fcbs);
...
int fluid_defpreset_noteon_with_seek(fluid_defpreset_t* preset, fluid_synth_t* synth, int chan, int key, int vel, int ticks);
