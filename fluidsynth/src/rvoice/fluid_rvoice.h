...
struct _fluid_rvoice_dsp_t
{
	...
	fluid_real_t preset_amplitude_offset;		/* preset amplitude offset */
...
void fluid_rvoice_set_preset_amplitude_offset(fluid_rvoice_t* voice, fluid_real_t value);
void fluid_rvoice_set_channel_gain(fluid_rvoice_t* voice, fluid_real_t value);
...
void fluid_rvoice_seek_to_ticks(fluid_rvoice_t* voice, int ticks);
