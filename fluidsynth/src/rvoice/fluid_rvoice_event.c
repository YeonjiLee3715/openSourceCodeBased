...
fluid_rvoice_event_dispatch(fluid_rvoice_event_t* event)
{
  ...
  EVENTFUNC_I1(fluid_rvoice_seek_to_ticks, fluid_rvoice_t*);
  ...
  EVENTFUNC_R1(fluid_rvoice_set_preset_amplitude_offset, fluid_rvoice_t*);
  EVENTFUNC_R1(fluid_rvoice_set_channel_gain, fluid_rvoice_t*);
  ...
  int finished_voices_size, int bufs, int fx_bufs, fluid_real_t sample_rate)
{
  ...
  FLUID_MEMSET (eventhandler, 0, sizeof (fluid_rvoice_eventhandler_t));
